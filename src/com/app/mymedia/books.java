...
public class books extends Activity{
	...
	public ArrayList<String> knigi = new ArrayList<String>();
	private ListView lv;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        {
            do {
                knigi.add(c.getString(1));
            } while (c.moveToNext());
        }
        db.close();
        
        adapter=new ArrayAdapter<String>(this,R.layout.book_list_tem, knigi);
	...
	private void createClickAlert(final int position, long id){  
	   	 ...
	   	 builder.setMessage("Do you want to delete the selected book: "+knigi.get(position)+"?")
    ...
    pMenu.add(0, MENU_ADD_ITEM, Menu.NONE, "Add Book!").setIcon(android.R.drawable.ic_menu_mylocation);
